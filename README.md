...
The Government of Canada's integration of PBMM Azure and M365 for Government reflects a progressive shift towards modernization. By embracing SaaS and PaaS models over the traditional IaaS approach, the government attains streamlined operations and resource optimization. This transition empowers the government to prioritize innovation and citizen services, while abstracting infrastructure complexities through PaaS for faster development and scalability. This strategic move underlines the system's role in enhancing efficiency, cost-effectiveness, and responsiveness, establishing the government as a technologically advanced and service-centric entity in today's digital landscape.

The incorporation of the Power Platform within this context amplifies the advantages of the SaaS approach, bolstering the Government of Canada's digital transformation. With a SaaS model, the Power Platform offers a predictable cost structure, eliminating the uncertainties associated with traditional infrastructure management. The availability of prebuilt CRM applications expedites the implementation of citizen-centric services, enhancing engagement and satisfaction. Additionally, the inclusion of Power Pages Websites empowers government agencies to swiftly establish a compelling online presence without intricate development efforts. This amalgamation of the Power Platform's capabilities not only aligns seamlessly with the government's modernization goals but also augments its ability to swiftly adapt to evolving needs while efficiently utilizing resources.

This project serves as the Git repository housing the Government of Canada Starter Kit tailored for the Power Platform, embodying a comprehensive approach that resonates with the Government's digital transformation aspirations. Within, you'll find the Power Pages Site, thoughtfully integrated with the WET Canada.ca framework, meticulously designed to align with the accessibility and aesthetic prerequisites of Federal Departments and Agencies. Complementing this core structure are accompanying CRM solutions, alongside an array of supportive and optional components. Noteworthy among these is an automated pipeline, carefully constructed to facilitate swift deployment through Azure DevOps for your development and configuration teams. Additionally, the repository encompasses a DocFX website, adaptable for hosting anywhere or within an Azure Storage account's blob container, seamlessly connected to an Azure Storage static web app. This architectural synergy with the Power Platform's support structure is further exemplified by its use for Portal diagnostics. The process to harness the potential of this repository is both intuitive and empowering. You're granted the choice to clone this repository and deploy it as a Git repository within your Azure DevOps tenant. Follow the guidelines outlined in our comprehensive documentation to seamlessly deploy the starter kit into your Power Platform environment across one or multiple Dataverse instances, all licensed with Dynamics 365 Customer Service licensing. 

This starter kit stands as a versatile template for any PBMM-driven implementation of a Power Platform project. This template effectively caters to the requisites of a Power Pages website, fortified with OIDC Single Sign On integration (be it GCCF consolidator, Sign in Canada, standalone Azure AD, or B2C), complemented by a CRM backend designed to process data seamlessly from the website. It proficiently governs the web publishing process for a multitude of verticals encompassing public-facing components, including but not limited to Grants and Contributions, Permits, and Regulatory/Compliance form submissions. Notably, the kit introduces an advanced form wizard, adeptly addressing the limitations encountered in multi-step forms. The website theme, meticulously evaluated against WCAG 2.x stipulations, guarantees accessibility compliance. Moreover, the enclosed documentation site can be seamlessly repurposed as a template for your technical documentation or as a support element for your security protocols, offering comprehensive evidence.

The subsequent section outlines a template for your own repository's overview page, designed to equip your development team with the necessary insights into your SLDC/ALM procedures. It exemplifies the modern ALM practices embraced by contemporary software implementation teams. It's important to note that while this section serves as a template, it remains adaptable to the unique practices of your team as you onboard new resources and navigate your project's development journey.

It's important to acknowledge that this marks our inaugural major open-source release, with numerous minor and major updates slated for the upcoming year. Stay attuned to new releases, where we'll distinctly demarcate stable versus preview builds and any consequential changes. Lastly, we extend an invitation to the broader developer community to contribute. The precise process for such contributions will be comprehensively detailed in the forthcoming release, scheduled for August 30, 2023.

Should you seek to expedite the integration of this entire stack within your organization, we offer dedicated services alongside SLA support. To glean further insights into these offerings, we invite you to explore our website or connect with us directly at contact@cloudstrucc.com. Given the open-source nature of this endeavor, we warmly welcome collaboration from fellow developers, fostering a collective pursuit of technological excellence.
...
2. When you are ready to merge in your changes to the primary development environment, you simply issue a PR to the "Development" branch which will trigger a pipline that will import your patch and or portal code into the main development environment (unmanaged) where you can verify that your patch doesnt have any dependency issues or fails our conventions (or industry wide conventions).
3. Note that at 3am every evening, a pipeline executes that migrates your dedicated patch to the staging (release) environment. However you have the flexibility to trigger this manually by running the PowerPlatform-CI-Staging pipeline manually. This is important so that you can validate that your work is deployable in a managed environment in preperation for a full release (twice a sprint/sometimes more frequently)
4. Every (X) day during a sprint you will issue a PR to the QA branch which will trigger a pipeline that will clone the yourproject, ORGANIZATION-Processes solutions in the main development environment and deploy to Staging (upgrade) and subsequently save the artefact for further deployments.
