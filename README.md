...
This project is the repository housing the Government of Canada Starter Kit tailored for the Power Platform, reflecting a comprehensive approach aligned with the Government's digital transformation goals. Enclosed within is the Power Pages Site, seamlessly integrated with the WET Canada.ca framework, designed to meet accessibility and aesthetic requirements of Federal Departments and Agencies. Accompanying CRM solutions and various optional components enhance this core structure. Noteworthy is the automated pipeline, facilitating swift deployment through Azure DevOps for development and configuration teams. The repository also encompasses a versatile DocFX website, adaptable for hosting anywhere or within an Azure Storage account's blob container, seamlessly connected to an Azure Storage static web app, showcasing architectural alignment with the Power Platform's support structure, utilized for Portal diagnostics. The process to harness the repository's potential is intuitive. You can clone it and deploy as a Git repository within your Azure DevOps tenant, following comprehensive documentation guidelines for seamless deployment into your Power Platform environment, licensed with Dynamics 365 Customer Service.

This starter kit offers a versatile template for PBMM-driven Power Platform projects. It caters to Power Pages websites, fortified with OIDC Single Sign On integration, including GCCF consolidator, Sign in Canada, standalone Azure AD, or B2C. A CRM backend processes data seamlessly from the website, governing web publishing for verticals like Grants, Contributions, Permits, and Regulatory/Compliance forms. The kit introduces an advanced form wizard, addressing multi-step form limitations, and its WCAG 2.x-compliant theme ensures accessibility. The documentation site can serve as a template for technical documentation and security protocols. The subsequent section outlines a template for repository overviews, embracing modern ALM practices. Noting this inaugural open-source release, expect minor and major updates, distinct stable/preview builds, and contributions welcomed from developers. Services with SLA support expedite stack integration, fostering collaboration for technological excellence.
